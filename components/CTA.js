const CTA = () => {
  return (
    <section className="bg-[#141414] text-[#ece8e0]">
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-10 pb-24 md:pt-16 md:pb-32 text-center">
        <h2 className="font-[RealHeadPro-SemiLight] text-white text-sm md:text-lg lg:text-xl tracking-tight uppercase md:whitespace-nowrap">
